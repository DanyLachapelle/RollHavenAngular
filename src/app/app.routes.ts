...
import { CampaignManagementComponent} from './campaign-management/campaign-management/campaign-management.component';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./campaign-management/campaign-management/campaign-management.component').then(m => m.CampaignManagementComponent),
  },
  {
    path: 'info-account',
  ...
  },
  {
    ...
    loadComponent: () => import('./campaign-management/campaign/campaign.component').then(m => m.CampaignComponent),
  },
];
